...
// ============================================================================
// Ham Engine V5.5: THE AEGIS EVALUATOR CORE
// ============================================================================
...
export abstract class EvaluatorCore {
    ...
    public async evaluate(ast: HamAST, env: Environment): Promise<any> {
    ...
    protected async evaluateNode(node: HamASTNode | undefined, env: Environment): Promise<any> {
    ...
    protected abstract evaluateOpcode(opcode: Opcode, args: any[], env: Environment): Promise<unknown>;
